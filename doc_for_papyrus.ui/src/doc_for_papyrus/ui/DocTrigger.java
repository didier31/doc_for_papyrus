...
public class DocTrigger extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException 
	{
		...
		if (selection instanceof IPapyrusFile)
		{
			...
			Bundle bundle = Platform.getBundle("doc_for_papyrus.ui");
			...
			String schema = "'" + cdir + "docbook.xsd'";
			...
			notifyErrorLog(bundle);
		}
		
		return null;
	}
	
	protected void notifyErrorLog(Bundle bundle)
	{
